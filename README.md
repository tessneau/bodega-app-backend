...
## Usage
La Bodega API is needed in order to accept HTTP requests from it's [frontend La Bodega](https://github.com/tessneau/bodega-app-frontend). This allows users to:
